...
from model.Prepare_inputs import SwinBert
...
class Swin_BERT(pl.LightningModule):

    def __init__(self, swin_freeze, lr, gra_clip, drop_swin,
                 weight_decay, max_length, drop_bert, bs, dataset, config_data,
        ...
        self.decoder = SwinBert.from_pretrained('bert-base-uncased', config=config)
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        # pass decoder
        outputs = self.decoder(**token_input, labels=label, encoder_hidden_states=enc_outputs_vision)
        loss = outputs.loss
